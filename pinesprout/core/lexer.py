...
KEYWORDS = {
    "if", "else", "for", "to", "while", "switch", "var", "varip",
    "import", "export", "method", "type", "true", "false", "na",
    "and", "or", "not", "in", "by", "continue", "break", "return",
    "series", "simple", "const", "input", "float", "int", "bool",
    "string", "color", "line", "label", "box", "table", "array",
    "matrix", "map",
}
